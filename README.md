...
This is a fork of [lharries/whatsapp-mcp](https://github.com/lharries/whatsapp-mcp). It differs from upstream in three ways:
...
|---|---|---|
| `WHATSAPP_WHISPER_MODEL` | `mlx-community/whisper-large-v3-turbo` | Transcription model |
| `WHATSAPP_TRANSCRIPTS_DB` | `whatsapp-bridge/store/transcriptions.db` | Transcript cache location |
